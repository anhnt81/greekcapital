                        ...
                        <div class="panel-body">
                            <div class="white-box">
                                <div class="user-bg"><img width="100%" alt="user"
                                                          src="https://wrappixel.com/ampleadmin/ampleadmin-html/plugins/images/large/img1.jpg">
                                    <div class="overlay-box">
                                        <div class="user-content">
                                            <a href="javascript:void(0)"><img src="{{ $profile->avatar}}"
                                ...
                                <div class="user-btm-box">
                                    <div class="col-md-6 col-sm-6 text-center">
                                        ...
                                        {{--<h1>{{ $profile->posts->count('name')}}</h1>--}}
                                    </div>
                                    <div class="col-md-6 col-sm-6 text-center">
                                        <p class="text-danger"><i class="fa fa-file" aria-hidden="true"></i></p>
                                        <h2>125</h2></div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <ul class="nav nav-tabs">
                                <li class="active"><a href="#home" data-toggle="tab" aria-expanded="true">Cập nhật
                                        Profile</a>
                                </li>
                                <li class=""><a href="#posts" data-toggle="tab" aria-expanded="false">Các bài
                                        đăng</a>
                                </li>
                            </ul>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade active in" id="home">
                                    ...
                                    <form action="admin/profile/update" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <label>Avatar</label>
                                            <input style="height: auto;" class="form-control" name="avatar" type="file"/>
                                        </div>
                                        <div class="form-group">
